...
Proof Key for Code Exchange (PKCE, defined in RFC 7636) is an extension to the OAuth2 Authorization Code flow. It was originally designed to protect mobile applications from authorization code interception attacks, but has since become the industry-standard best practice for _all_ OAuth2 clients, including Power BI custom connectors.
